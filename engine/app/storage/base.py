...
class GraphStorage(ABC):
    ...
    def wait_for_processing(
        ...
        For SurrealDB: no-op (synchronous processing).
        Kept for API compatibility with callers that expect async processing.
        """
    ...
    def search(
        ...
        Returns:
            Dict with 'edges' and/or 'nodes' lists
        """
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Get full graph data (enriched format).
